                            ...
                            <form action="" method="GET">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <ul class="text-center list-inline pb-3">
                                            ...
                                            <li class="list-inline-item"><span style="width: 150px" class="badge bg-secondary" id="var-value">1</span></li>
                                ...
                                <div class="row pb-3">
                                    {{-- <div class="col d-grid">
                                        <button type="submit" class="btn-outline-success btn-lg" name="submit" value="buy">Buy</button>
                                    </div> --}}
