...
<body>
    ...
    <section class="container py-5">
        <div class="row">
            {{-- <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="Zay/assets/img/category_img_01.jpg" class=" img-fluid border"></a>
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4">
                @foreach ($dtStok as $item)
                    <div class="col text-center">
                        <div class="card h-2">
                                <a href="{{ url('detail-product', $item->id) }}}">
                                    <img src="Zay/assets/img/carousel/pet_01.png" class="card-img-top" alt="...">
                                    <div class="card-body">
                                    <h5 class="card-title">{{ $item->nama_barang }}</h5>
                                    <p class="card-text">Rp {{ $item->harga_jual }}</p>
                                </a>
                            </div>
                        </div>
                    </div>
